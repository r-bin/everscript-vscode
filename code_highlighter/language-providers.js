'use strict';
// Language feature providers for the Everscript VS Code extension.
// Owner: code_highlighter/language-providers.js
// Provides: hover, completion, go-to-definition, find-references,
//           document symbols, dead-branch decorations.
// NO dependency on Memory Radar state or room building.
...
function loadIndex(extensionPath) {
    ...
    const p = path.join(extensionPath, 'code_highlighter', 'data', 'index.json');
...
module.exports = {
    ...
    getDeadDecorationType,
    updateDeadBranchDecorations,
