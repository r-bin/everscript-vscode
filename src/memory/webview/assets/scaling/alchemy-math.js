// Ownership: pure alchemy damage and stat calculation functions.
// Runs in the shared.js outer IIFE scope (no inner IIFE wrapper).
// Accessible to both the scaling tab and the docs tab.
